...
INNER JOIN bethadba.controle_migracao_registro cmrr ON (cmrr.i_chave_dsk3 = 'Outra' AND cmrr.tipo_registro = 'tipo-responsabilidade-tecnica' and cmrr.i_chave_dsk1 = {{entidade}})
