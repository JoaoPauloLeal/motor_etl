-- CORRIGE TODOS OS CREDORES QUE ESTEJA COM PROPOSTAS FALTANDO
-- NO CLOUD NAO E PERMITIDO PARA PODER HOMOLOGAR O PROCESSO
begin
   ...
   FOR roda2 AS cotia2 DYNAMIC SCROLL CURSOR FOR
		...
		SELECT DISTINCT i_entidades ent ,
			i_ano_proc ano_proc ,
			i_processo num_proc,
...
--------------------------- CORREÇÃO POR ENTIDADE E POR PROCESSO/ANO ---------------------------
begin
    declare comando long varchar;
    declare ano integer;
	declare entidade integer;
