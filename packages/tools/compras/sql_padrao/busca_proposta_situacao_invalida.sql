-- BUSCA TODAS AS PROPOSTA NA QUAL ESTEJA CON A SITUAÇÃO -> 'NAO_ANALISADO', 'EMPATE_REAL' OU 'CLASSIFICADO_LANCE'
-- NUCLEO DO SQL RETIRADO DO ARQJOB, ADICIONADO APENAS O FILTRO
SELECT * FROM (
