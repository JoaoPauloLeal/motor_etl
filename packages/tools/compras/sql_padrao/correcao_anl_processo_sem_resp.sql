-- CORRIGE TODAS AS ANULACOES/CORRECOES ONDE ESTEJA FALTANDO O RESPONSAVEL DA ANULACAO
-- O SQL BUSCA QUAL O RESPONSAVEL PELA COMISSAO DE LICITACAO E SETA O MESMO PARA SER O RESPONSAVEL DA ANULACAO
BEGIN
	DECLARE ano int;
	DECLARE proce int;
