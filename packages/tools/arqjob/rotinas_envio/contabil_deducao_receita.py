...
def coletar_dados_sybase_deducoes_receitas_ldo(params_alter):
    ...
    contador = 0
    try:
        query = model.get_consulta(params_alter, 'contabil_deducao_receita.sql_padrao')
        dados_sybase = []
...
def coletar_dados_sybase_controle_receitas_ldo():
    ...
    try:
        query = model.get_consulta(params_alter, 'coletar_dados_sybase_controle_receitas_ldo.sql_padrao')
        dados_sybase = []
