...
tipo_registro = 'planoscontas'
sistema = 999
limite_lote = 100
url = "https://livro-eletronico.cloud.betha.com.br/service-layer-livro/api/planoscontas"
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            "planosContas": {
                "iBancos": item["id_banco"],
                "mascara": item["mascara"],
                "descricao": item["descricao"],
                "planoVigente": item["plano_vigente"]
            }
        }
