...
def iniciar_processo_envio(params_exec, ano, *args, **kwargs):
    # processosAnexoBusca.iniciar_processo_busca(params_exec)
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            "conteudo": {
                "processoDocumento": {
                    "id": item["id_processo_docto_cloud"]
                    },
                # "nome": item["nome_doc"],
                # "assinar": item["assinar"],
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Processos Documentos Anexos',
            'id_gerado': None,
