...
import json
import packages.ipm_cloud_postgresql.protocolo.rotinas_envio.buscaProcessosAnexo as processosAnexoBusca
import logging
from datetime import datetime


tipo_registro = 'pareceres'
sistema = 304
limite_lote = 70
url = "https://api.protocolo.betha.cloud/protocolo/service-layer/v1/api/pareceres"
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            "conteudo": {
                ...
                "codigoParecer": item["codigo_parecer"],
                "encerrarProcesso": item["encerrar_processo"],
                "resultadoEncerramento": item["resultado_encerramento"],
                "parecerRegistro": item["parecer_restrito"],
                "usuario": {
                    "id": item["usuario"]
                },
                "idOrganograma": item["id_organograma_cloud"],
                "sigilosoExternamente": item["sigiloso_externamente"],
                "parecerRestrito": item["parecer_restrito_aux"],
                "emissao": item["emissao"],
                "observacao": item["observacao_aux"],
                "encerramentoProcesso": item["encerramento_processo"],
                "usuarioEncerramentoProcesso": {
                    "id": item["usuario_encerramento_processo"]
                }
            }
        }
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Pareceres',
            'id_gerado': None,
