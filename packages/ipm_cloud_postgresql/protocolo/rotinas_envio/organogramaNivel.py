...
tipo_registro = 'organogramaNivel'
sistema = 304
limite_lote = 500
url = "https://api.protocolo.betha.cloud/protocolo/service-layer/v1/api/organogramaNivel"
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        if "separador" in item and item["separador"] is not None:
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Nível de Organograma',
            'id_gerado': None,
