...
import packages.ipm_cloud_postgresql.protocolo.rotinas_envio.buscaClassificacao as classificacaoBusca
...
def iniciar_processo_envio(params_exec, ano, *args, **kwargs):
    classificacaoBusca.iniciar_processo_busca(params_exec)
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Classificação',
            'id_gerado': None,
