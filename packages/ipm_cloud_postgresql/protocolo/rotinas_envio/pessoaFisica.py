...
tipo_registro = 'pessoaFisica'
sistema = 304
limite_lote = 200
url = "https://api.protocolo.betha.cloud/protocolo/service-layer/v1/api/fisica"
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            "conteudo": {
                ...
                "ativo": item["ativo"],
                "nomeSocial": None if "nomeSocial" not in item else item["nome_social"],
