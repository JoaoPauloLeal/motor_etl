...
tipo_registro = 'processo-parte-interessadas'
sistema = 304
limite_lote = 100
url = "https://api.protocolo.betha.cloud/protocolo/service-layer/v1/api/processo-parte-interessadas"
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    contador = 0
    for item in dados:
        hash_chaves = model.gerar_hash_chaves(sistema, tipo_registro, item["key1"], item["id_codigo"], item["ano"], item["id_pessoa"])
        dict_dados = {
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Partes Interessadas',
            'id_gerado': None,
            'i_chave_dsk1': item["key1"],
            'i_chave_dsk2': item["id_codigo"],
            'i_chave_dsk3': item["ano"],
            'i_chave_dsk4': item["id_pessoa"]
        })
