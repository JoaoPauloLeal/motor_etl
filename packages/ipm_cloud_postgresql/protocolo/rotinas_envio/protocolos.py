...
import json
import packages.ipm_cloud_postgresql.protocolo.rotinas_envio.buscaProtocolos as protocolosBusca
import logging
...
def iniciar_processo_envio(params_exec, ano, *args, **kwargs):
    # protocolosBusca.iniciar_processo_busca(params_exec)
...
def iniciar_envio(params_exec, dados, metodo, *args, **kwargs):
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            "conteudo": {
                "localProtocolizacao": item["id_organograma_cloud"],
                "protocoladoEm": hoje,
                "protocoladoPor": item["protocolado_por"],
                "tipo": item["tipo"]
            }
        }
        contador += 1
        ...
        lista_controle_migracao.append({
            ...
            'descricao_tipo_registro': 'Cadastro de Protocolos',
            'id_gerado': None,
