...
tipo_registro = 'ordem-abastecimento'
sistema = 306
limite_lote = 50
url = "https://frotas.betha.cloud/frotas-services/api/conversoes/lotes/ordem-abastecimento"
    ...
    for item in dados:
        ...
        dict_dados = {
            ...
            "conteudo": {
                ...
                "numeroOrdem": int(item["numeroordem"]),
                "tipo": item["tipo"],
                "origem": item["origem"],
