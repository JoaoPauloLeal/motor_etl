...
def iniciar():
    ...
    # enviar(params_exec, 'solicitacao-recebimento')
    # -------------
    # enviar(params_exec, 'busca_contratacao', ano)
    # enviar(params_exec, 'solicitacao-recebimento-item')
    # enviar(params_exec, 'solicitacao-recebimento-comprovante')

    # MOD
    # enviar(params_exec, 'busca-solicitacoes')
    # enviar(params_exec, 'buscaMateriais')
    # enviar(params_exec, 'buscaFornecedos')
    # enviar(params_exec, 'buscaResponsaveis')
    # enviar(params_exec, 'buscaPrazosEntrega')
    # enviar(params_exec, 'buscaTiposObjeto')
    # enviar(params_exec, 'buscaUnidadeMedida')
    # enviar(params_exec, 'buscaFormasPagamento')

    enviar(params_exec, 'busca-lancamento-despesa')
    # enviar(params_exec, 'busca_ordens_de_abastecimento')
    # enviar(params_exec, 'busca_lancamento_despesas')
