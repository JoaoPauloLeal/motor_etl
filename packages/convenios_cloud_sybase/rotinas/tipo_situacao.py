...
sistema = 1
tipo_registro = 'tipo_situacao'
url = 'https://convenios.cloud.betha.com.br/convenios/api/tipos-situacoes'
...
def coletar_dados():
    dados_assunto = []
    descricao = {
        'descricao': ['Em andamento', 'Devolvido', 'Rescindido', 'Finalizado', 'Paralisado', 'Executado com Recursos Próprios', 'Concluído com Rec. Próprios',
                      'Concluído com Rec. Concedente',
                      'Outras']
    }
    identificador = {
        'identificador': ['1', '2', '3', '4', '5', '6', '7', '8', '99']
    }
