...
sistema = 1
tipo_registro = 'convenio_recebido_aditivo'
...
def iniciar_envio(params_exec, dados_assunto):
    ...
    for item in dados_assunto:
        ...
        url = f"https://convenios.cloud.betha.com.br/convenios/api/convenios-recebidos/{item['id_gerado_convenio']}/aditivos-convenios"
        ...
        if id_gerado is not None:
            registro = [
                ...
                tipo_registro,
                'Cadastro de convenio recebidos aditivo',
                str(id_gerado),
...
def search_exists(headers, dado):
    url_convenios_recebidos_consolidados_aditivo = f"https://convenios.cloud.betha.com.br/convenios/api/convenios-repassados/{dado['id_gerado_convenio']}/aditivos-convenios/"
    try:
        retorno = requests.get(url=url_convenios_recebidos_consolidados_aditivo, headers=headers)
