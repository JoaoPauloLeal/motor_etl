...
def load_layout():
    ...
    if retorno:
        layout = [
            [sg.Text('Usuário do cloud', size=(40, 1)), sg.Input(retorno['user_login'], key='user_login', size=(40, 1))],
            ...
            [sg.Text('ID da entidade desktop', size=(40, 1)), sg.Input(retorno['id_entidade'], key='id_entidade', size=(40, 1))],
            [sg.Text('Numero do plano de contas desktop', size=(40, 1)), sg.Input(retorno['i_plano_contas'], key='i_plano_contas', size=(40, 1))],
...
def save_settings(settings_file, parametros, values, params_exec):
    SETTINGS_KEYS_TO_ELEMENT_KEYS = {'id_entidade': params_exec['id_entidade'], 'i_plano_contas': params_exec['i_plano_contas'],
